    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-yellow-50 flex justify-center items-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <p className="text-center text-gray-600 mb-8">Join Meal Matchmaker today</p>
          ...
          <p className="text-center text-gray-600">
            ...
            <Link to="/login" className="text-orange-600 font-semibold hover:text-orange-800 ml-1">
              Login
            </Link>
          </p>
        </div>
